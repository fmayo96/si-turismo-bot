...
const Chat = () => {
  ...
  return (
    <div className="flex flex-col w-full h-3/4 overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none'] items-center max-w-2xl py-24 mx-auto">
      {/* Messages */}
      {renderedMessages}
